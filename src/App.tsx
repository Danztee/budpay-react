...
const App: React.FC<AppProps> = () => {
  ...
  //     // const res = await electricityProviders();

  //     // const res = await electricityValidate(
  //     //   "IBEDC",
  //     //   "prepaid",
  //     //   "1111111111111"
  //     // );

  //     // const res = await electricityRecharge(
  //     //   "IKEDC",
  //     //   "1111111111111",
  //     //   "prepaid",
  //     //   "1000",
  ...
  // const { standardCheckout } = useBudPay(
  //   "sk_live_cswltnqwc2rp7dedhblxpxmuoaz880jgqmi92dz"
  // );

  // console.log(standardCheckout);

  const budPay = new BudPay("sk_live_cswltnqwc2rp7dedhblxpxmuoaz880jgqmi92dz");
  const { acceptPayment, identityVerification } = budPay;

  // acceptPayment
  //   .verifyTransaction("61e469c330c2bc")
  //   .then((res) => console.log(res));

  identityVerification
    .verifyBVN("00000000000", "http://your_webhook_url")
    .then((res) => console.log(res));

  // identityVerification
  //   .accountNameVerify("000013", "0050883605")
  //   .then((res) => console.log(res));
